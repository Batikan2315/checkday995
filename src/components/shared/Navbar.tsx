          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                <button
                  type="button"
                  className="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800"
                >
          ...
          <Disclosure.Panel className="sm:hidden">
            ...
            <div className="border-t border-gray-700 pb-3 pt-4">
              <div className="flex items-center px-5">
                ...
                <div className="ml-3">
                  <div className="text-base font-medium text-white">Kullanıcı Adı</div>
                  <div className="text-sm font-medium text-gray-400">kullanici@email.com</div>
                </div>
                <button
                  type="button"
